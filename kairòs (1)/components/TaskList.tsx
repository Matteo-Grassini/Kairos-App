        ...
        return (
            ...
            <div className="flex items-center gap-4 p-4 w-full">
                ...
                <button
                    ...
                    className="p-2 text-slate-300 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-all opacity-0 group-hover:opacity-100 scale-90 group-hover:scale-100"
                    title="Elimina Task"
                >
                    <Trash2 size={18} />
                </button>
