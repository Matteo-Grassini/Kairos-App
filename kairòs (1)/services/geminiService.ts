...
export const calculateNutrition = async (foodDescription: string, files: UploadedFile[] = []): Promise<NutritionalInfo> => {
    try {
        ...
        parts.push({
            ...
            Sii realistico. Se non specificata la quantità, usa porzioni standard medie.
            Restituisci JSON.`
        });
...
export const analyzeDietPlan = async (files: UploadedFile[]): Promise<DietPlanResponse> => {
    try {
        ...
        parts.push({
            ...
            2. PROGRAMMA SETTIMANALE: Estrai la dieta completa per TUTTI i giorni della settimana presenti.
               - Mappa ogni giorno al 'dayIndex' corretto (0=Domenica, 1=Lunedì, ..., 6=Sabato).
               - Se la dieta è generica (es. "Giorno 1", "Giorno 2"), assumi Lunedì=1, Martedì=2, ecc.
               - Estrai Colazione, Pranzo, Cena, Snack per ogni giorno.
                                ...
                                properties: {
                                    ...
                                    meals: {
                                        ...
                                        items: {
                                            ...
                                            required: ["title", "type", "details", "suggestedTime"]
                                        }
                                    }
                                },
